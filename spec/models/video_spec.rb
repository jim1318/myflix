...
describe Video do
  ...
  describe "search_by_title" do
    ...
    it "returns an array of all matches ordered by created_at" do
      ...
      expect(Video.search_by_title("Family")).to eq([video1, video2])
    end
...
describe ".search", :elasticsearch do
  ...
  context "with title, description and reviews" do
    it 'returns an an empty array for no match with reviews option' do
      ...
      batman_review = Fabricate(:review, user: Fabricate(:user), video: batman, review_text: "such a star movie!")
      refresh_index
    ...
    it 'returns an array of many videos with relevance title > description > review' do
      ...
      batman    = Fabricate(:video, title: "Batman")
      batman_review = Fabricate(:review, video: batman, user: Fabricate(:user), review_text: "such a star movie!")
      refresh_index
