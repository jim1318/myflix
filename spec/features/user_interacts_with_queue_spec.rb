...
feature 'User interacts with the queue' do
  scenario "user adds and reorders videos in the queue" do
    ...
    expect_link_no_to_be_seen("+ My Queue")
    
    #Add 2 more movies to the queue
    add_video_to_queue(south_park)
    add_video_to_queue(futurama)

    #Reorder the items in the queue (Different Methods)
...
def expect_link_no_to_be_seen(link_text)
